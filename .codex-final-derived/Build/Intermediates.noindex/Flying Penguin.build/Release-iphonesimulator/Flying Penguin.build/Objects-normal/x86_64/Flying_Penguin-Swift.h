...
#ifndef FLYING_PENGUIN_SWIFT_H
#define FLYING_PENGUIN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Flying_Penguin",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14Flying_Penguin8AppAudio")
...
SWIFT_CLASS("_TtC14Flying_Penguin11AppDelegate")
...
/// pipeline. A single shared instance, wired up from <code>Jumping_FoxApp</code>.
SWIFT_CLASS("_TtC14Flying_Penguin19NotificationManager")
...
@interface NotificationManager (SWIFT_EXTENSION(Flying_Penguin)) <UNUserNotificationCenterDelegate>
