...
nonisolated extension LocalizedStringResource {
    ...
    /**
     Localized string for key “game.combo %lld” in table “Localizable.xcstrings”.
     */
    static func gameCombo(_ arg1: Int) -> LocalizedStringResource {
        LocalizedStringResource("game.combo %lld", defaultValue: "\(arg1, specifier: "%lld")", table: "Localizable", bundle: resourceBundleDescription)
    }
    ...
    static var gameEndCompletionSuffix: LocalizedStringResource {
        LocalizedStringResource("game.end.completionSuffix", table: "Localizable", bundle: resourceBundleDescription)
    }
    ...
    /**
     Localized string for key “home.totalLabel” in table “Localizable.xcstrings”.
     */
    static var homeTotalLabel: LocalizedStringResource {
        LocalizedStringResource("home.totalLabel", table: "Localizable", bundle: resourceBundleDescription)
    }
    ...
    /**
     The translations render a longer sentence than the English, carried over from earlier copy. Accurate enough to ship; worth tightening one day.
     ...
     */
    static func parentGateHoldInstruction(_ arg1: String, _ arg2: Int) -> LocalizedStringResource {
        LocalizedStringResource("parentGate.holdInstruction %@ %lld", defaultValue: "\(arg1)\(arg2, specifier: "%lld")", table: "Localizable", bundle: resourceBundleDescription)
    }
     ...
     */
    static func parentGateTapInstruction(_ arg1: Int, _ arg2: String) -> LocalizedStringResource {
        LocalizedStringResource("parentGate.tapInstruction %lld %@", defaultValue: "\(arg1, specifier: "%lld")\(arg2)", table: "Localizable", bundle: resourceBundleDescription)
    }
    ...
    /**
     The count is always 500, 1500, 3000 or 5000 (GameConfig.characterUnlockRequirements).
    ...
    static var premiumFeatureAnimalsSubtitle: LocalizedStringResource {
        LocalizedStringResource("premium.feature.animals.subtitle", table: "Localizable", bundle: resourceBundleDescription)
    }
    ...
    /**
     Localized string for key “premium.feature.levels.title” in table “Localizable.xcstrings”.
     */
    static var premiumFeatureLevelsTitle: LocalizedStringResource {
        LocalizedStringResource("premium.feature.levels.title", table: "Localizable", bundle: resourceBundleDescription)
    }
    ...
    /**
     Localized string for key “settings.goalInfo” in table “Localizable.xcstrings”.
     */
    static var settingsGoalInfo: LocalizedStringResource {
        LocalizedStringResource("settings.goalInfo", table: "Localizable", bundle: resourceBundleDescription)
    }
    ...
    /**
     Localized string for key “tutorial.step1” in table “Localizable.xcstrings”.
     */
    static var tutorialStep1: LocalizedStringResource {
        LocalizedStringResource("tutorial.step1", table: "Localizable", bundle: resourceBundleDescription)
    }

    /**
     Localized string for key “tutorial.step2” in table “Localizable.xcstrings”.
     */
    static var tutorialStep2: LocalizedStringResource {
        LocalizedStringResource("tutorial.step2", table: "Localizable", bundle: resourceBundleDescription)
    }

    /**
     Localized string for key “tutorial.step3” in table “Localizable.xcstrings”.
     */
    static var tutorialStep3: LocalizedStringResource {
        LocalizedStringResource("tutorial.step3", table: "Localizable", bundle: resourceBundleDescription)
    }

    /**
     Localized string for key “tutorial.step4” in table “Localizable.xcstrings”.
     */
    static var tutorialStep4: LocalizedStringResource {
        LocalizedStringResource("tutorial.step4", table: "Localizable", bundle: resourceBundleDescription)
    }

    /**
     Localized string for key “tutorial.step5” in table “Localizable.xcstrings”.
     */
    static var tutorialStep5: LocalizedStringResource {
        LocalizedStringResource("tutorial.step5", table: "Localizable", bundle: resourceBundleDescription)
    }

    /**
     Localized string for key “tutorial.step6” in table “Localizable.xcstrings”.
     */
    static var tutorialStep6: LocalizedStringResource {
        LocalizedStringResource("tutorial.step6", table: "Localizable", bundle: resourceBundleDescription)
    }

    /**
     Localized string for key “tutorial.step7” in table “Localizable.xcstrings”.
     */
    static var tutorialStep7: LocalizedStringResource {
        LocalizedStringResource("tutorial.step7", table: "Localizable", bundle: resourceBundleDescription)
    }
}